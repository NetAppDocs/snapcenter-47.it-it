...
. Nella vista Gestisci copie, selezionare la risorsa clonata (ad esempio, il database o LUN), quindi fare clic su * *image:../media/split_cone.gif["icona del clone split"].
