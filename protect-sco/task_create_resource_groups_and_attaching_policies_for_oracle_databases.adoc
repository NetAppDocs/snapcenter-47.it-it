...
image::../media/sco_resourcegroup_policy.gif[aggiungi criterio dal gruppo di risorse]
...
.. Fare clic su * *image:../media/add_policy_from_resourcegroup.gif["aggiungi criterio dal gruppo di risorse"] nella colonna Configura pianificazioni per configurare la pianificazione della verifica per tutti i tipi di pianificazione del criterio.
