...
* * *image:../media/enable_ca_issues_icon.png["icona problemi ca"]Indica che non è stato attivato o assegnato alcun certificato CA all'host del plug-in.
...
* * *image:../media/enable_ca_undefined_icon.png["icona ca non definita"]indica che non è stato possibile recuperare le informazioni di connessione.
