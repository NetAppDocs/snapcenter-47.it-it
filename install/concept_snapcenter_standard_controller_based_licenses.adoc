...
+
** image:../media/controller_licensed_icon.gif["icona della licenza del controller"] Indica che una licenza della suite SnapManager è installata su un sistema di storage primario FAS o AFF.
** image:../media/controller_not_licensed_icon.gif["icona del controller non concesso in licenza"] Indica che una licenza della suite SnapManager non è installata su un sistema di storage primario FAS o AFF.
...
+
image::../media/nss_controller_license_select.gif[selezionare la licenza del controller]
...
+
Per informazioni sui cmdlet, vedere https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["Guida di riferimento al cmdlet del software SnapCenter"^].
