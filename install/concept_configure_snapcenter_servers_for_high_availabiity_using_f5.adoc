...
image::../media/sc-F5-configure-workflow.gif[configurare ha con f5]
...
+
Per ulteriori informazioni, vedere https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["Guida di riferimento al cmdlet del software SnapCenter"^].
