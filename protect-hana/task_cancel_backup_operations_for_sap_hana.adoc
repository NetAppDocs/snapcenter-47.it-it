...
'''
permalink: Barra laterale Protect-hana/task_cancel_backup_operations_for_sap_hana.html: Barra laterale parole chiave: riepilogo: 'È possibile annullare le operazioni di backup che sono in coda.' --- = Annulla le operazioni di backup per SAP HANA :Icons: Font :imagesdir: ../media/
